function changeFeatures(x) {
    if (x.matches) {
        ...
        $('nav').html(
            '<a href="index.html"><i class="fa fa-home" aria-hidden="true"></i></a><a href="#">ABOUT</a><a href="#">SKILLS</a><a href="projects.html">PROJECTS</a><a href="contact.html">CONTACT</a>'
        );
    }
}
